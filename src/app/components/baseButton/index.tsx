...
function BaseButton(props:BaseButtonProps) {
    ...
    className={props.white?"w-full flex items-center justify-center cursor-pointer gap-2 h-[50px] px-4 border-[1px] border-[#009668] rounded-[15px] shadow-sm text-[#009668] bg-white hover:bg-white focus:outline-none focus:ring-2 focus:ring-[#009668] focus:ring-offset-2":`w-full cursor-pointer flex items-center justify-center gap-2 h-[50px] px-4 border border-transparent rounded-[15px] text-white ${props.loading || props.disabled?"bg-[#80808062] ":"bg-[#009668] hover:bg-[#009668]"}  focus:outline-none focus:ring-2 focus:ring-[#009668]focus:ring-offset-2`}>
