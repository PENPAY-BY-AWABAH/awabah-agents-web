...
import { PaymentComponent } from "../user-onboarding/components/payment";
import { FormEvent, useEffect, useState } from "react";
import { UserItemProp } from "../components/users";
import { SignUpProps } from "../user-onboarding/page";
...
const Page = () => {
    ...
    const {getProviders,validateRSA,remitMicroPension} = useHttpHook();
