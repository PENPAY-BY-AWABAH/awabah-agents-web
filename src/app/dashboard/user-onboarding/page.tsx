  ...
  const handleFileChange = (e:any) => {
    ...
    if (selectedFile) {
      ...
      reader.onload = async function(e:any) {
        ...
        const compressedBase64 = await reduceImageSize(base64String, 0.7, 460, 460);
        ...
        {section !== "Success" ? <div className="m-auto items-center text-center h-full overflow-x-scroll">
            ...
            {userIsMinor &&<div className="text-left mb-4" >
                <BaseSelect 
                    label="Gender"
    list={[
        {title:"MALE",name:"MALE",value:"MALE"},
        {title:"FEMALE",name:"FEMALE",value:"FEMALE"}
    ] as ItemProps[]}
                ...
                {userIsMinor &&<div className="text-left mb-0" >
                <BaseInputDate
                            showOnly="date"
                            type="date"
                            name="dob"
                            value={dayjs(formData.dob!).format("DD-MM-YYYY")}
                            direction="right"
                            format="DD-MM-YYYY"
