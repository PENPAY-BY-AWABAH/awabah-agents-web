...
const flipCamera = async () => {
  ...
  const handleCapture = () => {
   ...
   <div className="border flex-grow relative border-gray-200 bg-gray-800 rounded-lg overflow-hidden h-[300px] ">
    ...
    className="p-2 py-5 border-[1px] text-green-800 border-green-800 rounded-[10px] flex items-center justify-center mt-5 gap-2 w-full hover:bg-gray-50">
       <CameraIcon  />
      <div >Snap</div> 
    </button>
    </div>
